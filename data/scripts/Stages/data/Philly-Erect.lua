function onCreate()
	if lowQuality == false then
		makeLuaSprite('sky', 'Stages/Erect/Week3/philly/erect/sky', -100, 0)
		setScrollFactor('sky', 0.1, 0.1)
		addLuaSprite('sky')
	end

	makeLuaSprite('city', 'Stages/Erect/Week3/philly/erect/city', -10, 0)
	...
	if lowQuality == false then
		makeLuaSprite('behindTrain', 'Stages/Erect/Week3/philly/erect/behindTrain', -40, 50)
	...
	makeLuaSprite('street', 'Stages/Erect/Week3/philly/erect/street', -40, 50)
	addLuaSprite('street')
end
