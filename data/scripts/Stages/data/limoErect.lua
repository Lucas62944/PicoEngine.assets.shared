function onCreate()
	makeLuaSprite('sunset', 'Stages/Erect/Week4/erect/limoSunset', -220, -80)
	scaleObject('sunset', 0.9, 0.9)
	setScrollFactor('sunset', 0.1, 0.1)
	addLuaSprite('sunset')

	makeAnimatedLuaSprite('shootingStar', 'Stages/Erect/Week4/erect/shooting star', 200, 0)
	...
	if lowQuality == false then
		makeAnimatedLuaSprite('limoBG', 'Stages/Erect/Week4/erect/bgLimo', -200, 480)
	...
	makeAnimatedLuaSprite('limo', 'Stages/Erect/Week4/erect/limoDrive', -120, 520)
