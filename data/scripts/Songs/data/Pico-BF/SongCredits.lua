...
function onCountdownStarted()
    local songName = 'Pico (BF-Mix)' -- what's gonna be displayed in the first line
    local songComposer = 'Composer: Saruky' -- what's gonna be displayed in the second line
    local charter = 'Charters: Fabs + Spazkid' -- what's gonna be displayed in the third line
