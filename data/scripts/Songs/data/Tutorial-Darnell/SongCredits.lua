...
function onCountdownStarted()
    local songName = 'TuTorial (Darnell-Mix)' -- what's gonna be displayed in the first line
    local songComposer = 'Composer: Vanished_Demon' -- what's gonna be displayed in the second line
    local charter = 'Charter: Vanished_Demon' -- what's gonna be displayed in the third line
