...
function onCountdownStarted()
    local songName = 'Malediction (Pico-Mix)' -- what's gonna be displayed in the first line
    local songComposer = 'Composer: Didiuwuw' -- what's gonna be displayed in the second line
    local charter = 'Charter: Didiuwuw' -- what's gonna be displayed in the third line
