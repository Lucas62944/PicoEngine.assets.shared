...
function onCountdownStarted()
    local songName = 'Dad-Battle (Pico-Mix)' -- what's gonna be displayed in the first line
    local songComposer = 'Composer: Clarky_Dev' -- what's gonna be displayed in the second line
    local charter = 'Charter: LimeIsHere/RubyyyButCool' -- what's gonna be displayed in the third line
