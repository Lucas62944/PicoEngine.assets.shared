...
function onCountdownStarted()
    local songName = 'Darnell-Erect' -- what's gonna be displayed in the first line
    local songComposer = 'Composer: Pf0r' -- what's gonna be displayed in the second line
    local charter = 'Charter: Pf0r' -- what's gonna be displayed in the third line
