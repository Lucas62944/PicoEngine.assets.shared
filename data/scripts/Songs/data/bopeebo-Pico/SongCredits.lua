...
function onCountdownStarted()
    local songName = 'bopeebo (Pico-Mix)' -- what's gonna be displayed in the first line
    local songComposer = 'Composer: ThatAndyGuy (feat. Saruky)' -- what's gonna be displayed in the second line
    local charter = 'Charter: Fabs + Spazkid' -- what's gonna be displayed in the third line
