...
function onCountdownStarted()
    local songName = 'Darnell (Tankman-Mix)' -- what's gonna be displayed in the first line
    local songComposer = 'Composer: DoritosDude' -- what's gonna be displayed in the second line
    local charter = 'Charter: DoritosDude' -- what's gonna be displayed in the third line
