...
function onCreatePost()
    ...
    addLuaScript('data/scripts/characters/data/abot-speaker')
    callScript('data/scripts/characters/data/abot-speaker', 'createSpeaker', {'nene', 0, 0}) -- {characterName, offsetX, offsetY}
